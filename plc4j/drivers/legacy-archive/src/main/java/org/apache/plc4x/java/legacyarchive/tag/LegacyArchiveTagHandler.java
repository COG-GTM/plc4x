...
/** Parses the address strings the legacy-archive driver accepts. */
public class LegacyArchiveTagHandler implements PlcTagHandler {

    @Override
    public PlcTag parseTag(String tagAddress) {
        if (LegacyArchiveTag.matches(tagAddress)) {
